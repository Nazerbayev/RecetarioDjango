...
def create_question(question_text, days):
    ...
    :param question_text: The Question text message
...
class QuestionViewTests(TestCase):
    def test_index_view_with_no_questions(self):
        ...
        :return:
        """
        response = self.client.get(reverse('recetario:index'))
    ...
    def test_index_view_with_future_and_past_question(self):
        """
        Even if both past and future questions exist, only past question should
        be displayed
        :return:
        """
        create_question(question_text='Past question.', days=-30)
...
class QuestionIndexDetailTests(TestCase):
    def test_detail_view_with_a_future_question(self):
        ...
        response = self.client.get(reverse('recetario:detail', args=(future_question.id,)))
    ...
    def test_detail_view_with_a_past_question(self):
        ...
        response = self.client.get(reverse('recetario:detail', args=(past_question.id,)))
